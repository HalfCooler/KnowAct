...
read the [upstream nanobot WebUI guide](https://github.com/HKUDS/nanobot/blob/main/docs/webui.md).
You do not need Node.js, Bun, Vite, or anything in this directory unless you are
changing the frontend.

For the local framework overview, see [`README.md`](../README.md). For nanobot's
complete usage documentation, see the
[upstream docs](https://github.com/HKUDS/nanobot/tree/main/docs).

## Pick a Path

| Goal | Start with | Opens at |
|---|---|---|
| Use the bundled browser UI | [Upstream WebUI guide](https://github.com/HKUDS/nanobot/blob/main/docs/webui.md) | `http://127.0.0.1:8765` |
| Use the WebUI from another device | [LAN access](https://github.com/HKUDS/nanobot/blob/main/docs/webui.md#lan-access) | `http://<your-ip>:8765` |
| Change WebUI source code | [Develop the WebUI (Vite HMR)](#develop-the-webui-vite-hmr) | `http://127.0.0.1:5173` |
| Debug setup failures | [Upstream troubleshooting](https://github.com/HKUDS/nanobot/blob/main/docs/troubleshooting.md#webui-problems) | Diagnosis order and common fixes |
